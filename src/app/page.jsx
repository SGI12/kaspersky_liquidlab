    ...
    <main className="flex min-h-screen flex-col items-center  justify-center " >
      <div className="flex flex-col items-center justify-start max-w-screen-sm w-full ">
        ...
        {!form && <div className="w-full max-w-screen-md">
          ...
          <div {...longPressEvent} className="px-5 pt-14 mb-4 w-full cursor-pointer justify-center h-full ">
          {!loading && <div className="pb-8 flex justify-center items-center gap-2 text-5">
            ...
            <div className="bg-tongue bg-no-repeat h-full bg-center bg-contain w-full min-h-[350px] mb-8">
            </div>
