...
import kiss from  "../../public/kiss.gif";
...
export default function Home() {
  ...
  return (
    ...
    <Image  priority={true} src={kiss} alt="kiss" className="rounded-[20px] w-full h-[350px] hidden" width={350} height={350} />
      <div className="flex flex-col items-center justify-start max-w-screen-sm w-full ">
        ...
        {!form && <div className="w-full max-w-screen-md">
          <Image src='/doctor.jpg' className="max-w-screen-sm w-full" width={350} height={250} alt="doctor" />
          ...
          <div className="pb-8 flex justify-center items-center gap-2 text-5">
            <span>Please, scan within 3 secs...</span>
            ...
            <div {...longPressEvent} className="bg-tongue bg-no-repeat h-full bg-center bg-contain w-full min-h-[350px] mb-8">
            </div>
        ...
        {form && !resultLoading && !result && <div className="w-full animate-slideLeft h-screen min-w-[350px] pt-8 left-0">
          ...
          <div className="px-5 flex flex-col justify-center items-start gap-[24px] mb-[35px] w-full">
            ...
            <div className="flex flex-col gap-4 w-full" >
              ...
              <input onChange={(e) => setName(e.target.value)} type="text" className="w-full drop-shadow-md focus:outline-none bg-bg-white h-[60px] pl-4 text-liquid-accent rounded-xl" />
            </div>

            <div className="flex flex-col gap-4 w-full" >
              <h3 className="text-lg">Date of Birth</h3>
              <input onChange={(e) => setBirth(e.target.value)} type="text" placeholder="__.__.__" className="w-full focus:outline-none placeholder:text-liquid-accent drop-shadow-md pl-4 text-liquid-accent bg-bg-white h-[60px] rounded-md" />
            </div>

            <div className="flex flex-col gap-4 w-full" >
              <h3 className="text-lg">ID Number</h3>
              <input  onChange={(e) => setId(e.target.value)}type="phone" className="w-full drop-shadow-md focus:outline-none  bg-bg-white h-[60px] pl-4 text-liquid-accent rounded-xl" />
            </div>
        ...
        {cat && <div className='flex px-5  flex-col justify-end h-full items-center w-full fixed bottom-0 backdrop-blur-md bg-bg-liquid-blur right-auto  '>
          <div className="pb-12">
            <Image  priority={true} src={kiss} alt="kiss" className="rounded-[20px] w-full h-[350px]" width={350} height={350} />
          </div>
